...
#define P2_4_DM_ALG_HIZ         (0x00u << P2_4_DRIVE_MODE_SHIFT)
#define P2_4_DM_DIG_HIZ         (0x01u << P2_4_DRIVE_MODE_SHIFT)
#define P2_4_DM_RES_UP          (0x02u << P2_4_DRIVE_MODE_SHIFT)
#define P2_4_DM_RES_DWN         (0x03u << P2_4_DRIVE_MODE_SHIFT)
#define P2_4_DM_OD_LO           (0x04u << P2_4_DRIVE_MODE_SHIFT)
#define P2_4_DM_OD_HI           (0x05u << P2_4_DRIVE_MODE_SHIFT)
#define P2_4_DM_STRONG          (0x06u << P2_4_DRIVE_MODE_SHIFT)
#define P2_4_DM_RES_UPDWN       (0x07u << P2_4_DRIVE_MODE_SHIFT)
