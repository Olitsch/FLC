// ======================================================================
// FLC.v generated from TopDesign.cysch
// 02/17/2015 at 15:46
...
// TCPWM_P4_v1_10(PWMCompare=10000, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=100, PWMInterruptMask=0, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=1, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=0, TCCapturePresent=false, TCCompare=5, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=1, TCPeriod=10, TCPrescaler=0, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=false, TCRunMode=0, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, CY_COMPONENT_NAME=TCPWM_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=PWM_Timer, CY_INSTANCE_SHORT_NAME=PWM_Timer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=PWM_Timer, )
...
// TCPWM_P4_v1_10(PWMCompare=65535, PWMCompareBuf=65535, PWMCompareSwap=0, PWMCountMode=3, PWMCountPresent=false, PWMDeadTimeCycle=0, PWMInterruptMask=1, PWMKillEvent=0, PWMLinenSignal=0, PWMLineSignal=0, PWMMode=4, PWMPeriod=65535, PWMPeriodBuf=65535, PWMPeriodSwap=0, PWMPrescaler=0, PWMReloadMode=0, PWMReloadPresent=false, PWMRunMode=0, PWMSetAlign=0, PWMStartMode=0, PWMStartPresent=false, PWMStopEvent=0, PWMStopMode=0, PWMStopPresent=false, PWMSwitchMode=0, PWMSwitchPresent=false, QuadEncodingModes=0, QuadIndexMode=0, QuadIndexPresent=false, QuadInterruptMask=1, QuadPhiAMode=3, QuadPhiBMode=3, QuadStopMode=0, QuadStopPresent=false, TCCaptureMode=1, TCCapturePresent=true, TCCompare=65535, TCCompareBuf=65535, TCCompareSwap=0, TCCompCapMode=2, TCCountingModes=0, TCCountMode=3, TCCountPresent=false, TCInterruptMask=2, TCPeriod=65535, TCPrescaler=4, TCPWMCapturePresent=false, TCPWMConfig=1, TCPWMCountPresent=false, TCPWMReloadPresent=false, TCPWMStartPresent=false, TCPWMStopPresent=false, TCReloadMode=0, TCReloadPresent=true, TCRunMode=1, TCStartMode=0, TCStartPresent=false, TCStopMode=0, TCStopPresent=false, CY_COMPONENT_NAME=TCPWM_P4_v1_10, CY_CONTROL_FILE=<:default:>, CY_FITTER_NAME=RC_Timer, CY_INSTANCE_SHORT_NAME=RC_Timer, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=10, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=cydsfit No Version Information Found, INSTANCE_NAME=RC_Timer, )
...
module SCB_P4_v1_20_4 (
	...
	cy_clock_v1_0
		#(.id("7910852d-9f9b-40e7-bb87-3a0e4d3d82ef/81fcee8a-3b8b-4be1-9a5f-a5e2e619a938"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7910852d-9f9b-40e7-bb87-3a0e4d3d82ef/23b8206d-1c77-4e61-be4a-b4037d5de5fc"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("7910852d-9f9b-40e7-bb87-3a0e4d3d82ef/78e33e5d-45ea-4b75-88d5-73274e8a7ce4"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
...
module top ;
    ...
    TCPWM_P4_v1_10_0 PWM_Timer (
        ...
        .line_n(Net_275),
        .clock(Net_398));
    defparam PWM_Timer.PWMCountMode = 3;
    defparam PWM_Timer.PWMReloadMode = 0;
    defparam PWM_Timer.PWMReloadPresent = 0;
    defparam PWM_Timer.PWMStartMode = 0;
    defparam PWM_Timer.PWMStopMode = 0;
    defparam PWM_Timer.PWMSwitchMode = 0;
    defparam PWM_Timer.QuadIndexMode = 0;
    defparam PWM_Timer.QuadPhiAMode = 3;
    defparam PWM_Timer.QuadPhiBMode = 3;
    defparam PWM_Timer.QuadStopMode = 0;
    defparam PWM_Timer.TCCaptureMode = 0;
    defparam PWM_Timer.TCCountMode = 3;
    defparam PWM_Timer.TCReloadMode = 0;
    defparam PWM_Timer.TCStartMode = 0;
    defparam PWM_Timer.TCStopMode = 0;
    ...
    TCPWM_P4_v1_10_1 Blink_Timer (
        ...
        .line_n(Net_449),
        .clock(Net_398));
    defparam Blink_Timer.PWMCountMode = 3;
    defparam Blink_Timer.PWMReloadMode = 0;
    defparam Blink_Timer.PWMReloadPresent = 0;
    defparam Blink_Timer.PWMStartMode = 0;
    defparam Blink_Timer.PWMStopMode = 0;
    defparam Blink_Timer.PWMSwitchMode = 0;
    defparam Blink_Timer.QuadIndexMode = 0;
    defparam Blink_Timer.QuadPhiAMode = 3;
    defparam Blink_Timer.QuadPhiBMode = 3;
    defparam Blink_Timer.QuadStopMode = 0;
    defparam Blink_Timer.TCCaptureMode = 0;
    defparam Blink_Timer.TCCountMode = 3;
    defparam Blink_Timer.TCReloadMode = 0;
    defparam Blink_Timer.TCStartMode = 0;
    defparam Blink_Timer.TCStopMode = 0;

    TCPWM_P4_v1_10_2 RC_Timer (
        .stop(1'b0),
        .reload(Net_221),
        .start(1'b0),
        .count(1'b1),
        ...
        .line_n(Net_196),
        .clock(Net_398));
    defparam RC_Timer.PWMCountMode = 3;
    defparam RC_Timer.PWMReloadMode = 0;
    defparam RC_Timer.PWMReloadPresent = 0;
    defparam RC_Timer.PWMStartMode = 0;
    defparam RC_Timer.PWMStopMode = 0;
    defparam RC_Timer.PWMSwitchMode = 0;
    defparam RC_Timer.QuadIndexMode = 0;
    defparam RC_Timer.QuadPhiAMode = 3;
    defparam RC_Timer.QuadPhiBMode = 3;
    defparam RC_Timer.QuadStopMode = 0;
    defparam RC_Timer.TCCaptureMode = 1;
    defparam RC_Timer.TCCountMode = 3;
    defparam RC_Timer.TCReloadMode = 0;
    defparam RC_Timer.TCStartMode = 0;
    defparam RC_Timer.TCStopMode = 0;


	cy_clock_v1_0
		#(.id("0d11c86d-aacc-4ed9-bf0f-95aafcb0b86a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("1000000000"),
		  .is_direct(0),
    ...
    SCB_P4_v1_20_3 UART_1 (
        .sclk(Net_202),
        .interrupt(Net_205),
        .clock(1'b0));

    SCB_P4_v1_20_4 UART_2 (
        .sclk(Net_58),
        .interrupt(Net_59),
        .clock(1'b0));

	wire [0:0] tmpOE__LandingLight_net;
	wire [0:0] tmpFB_0__LandingLight_net;
	wire [0:0] tmpIO_0__LandingLight_net;
	wire [0:0] tmpINTERRUPT_0__LandingLight_net;
	electrical [0:0] tmpSIOVREF__LandingLight_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("0e0c9380-6965-4440-8709-ce08a91e474c"),
		  ...
		  .width(1))
		LandingLight
		 (.oe(tmpOE__LandingLight_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__LandingLight_net[0:0]}),
		  .io({tmpIO_0__LandingLight_net[0:0]}),
		  .siovref(tmpSIOVREF__LandingLight_net),
		  .interrupt({tmpINTERRUPT_0__LandingLight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__LandingLight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__NavLight_net;
	wire [0:0] tmpFB_0__NavLight_net;
	wire [0:0] tmpIO_0__NavLight_net;
	wire [0:0] tmpINTERRUPT_0__NavLight_net;
	electrical [0:0] tmpSIOVREF__NavLight_net;

	cy_psoc3_pins_v1_10
		#(.id("3d3ba8db-ad4a-4143-b502-da412c3ca2f7"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		NavLight
		 (.oe(tmpOE__NavLight_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__NavLight_net[0:0]}),
		  .io({tmpIO_0__NavLight_net[0:0]}),
		  .siovref(tmpSIOVREF__NavLight_net),
		  .interrupt({tmpINTERRUPT_0__NavLight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__NavLight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__StrobeLight_net;
	wire [0:0] tmpFB_0__StrobeLight_net;
	wire [0:0] tmpIO_0__StrobeLight_net;
	wire [0:0] tmpINTERRUPT_0__StrobeLight_net;
	electrical [0:0] tmpSIOVREF__StrobeLight_net;

	cy_psoc3_pins_v1_10
		#(.id("94444736-2e8c-44b3-9365-d74a4ba09f1a"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		StrobeLight
		 (.oe(tmpOE__StrobeLight_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__StrobeLight_net[0:0]}),
		  .io({tmpIO_0__StrobeLight_net[0:0]}),
		  .siovref(tmpSIOVREF__StrobeLight_net),
		  .interrupt({tmpINTERRUPT_0__StrobeLight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__StrobeLight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__CollisionLight_net;
	wire [0:0] tmpFB_0__CollisionLight_net;
	wire [0:0] tmpIO_0__CollisionLight_net;
	wire [0:0] tmpINTERRUPT_0__CollisionLight_net;
	electrical [0:0] tmpSIOVREF__CollisionLight_net;

	cy_psoc3_pins_v1_10
		#(.id("15554942-3c96-42d9-aeb0-e5e1c1998bac"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .width(1))
		CollisionLight
		 (.oe(tmpOE__CollisionLight_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__CollisionLight_net[0:0]}),
		  .io({tmpIO_0__CollisionLight_net[0:0]}),
		  .siovref(tmpSIOVREF__CollisionLight_net),
		  .interrupt({tmpINTERRUPT_0__CollisionLight_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__CollisionLight_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__P2_4_net;
	wire [0:0] tmpIO_0__P2_4_net;
	wire [0:0] tmpINTERRUPT_0__P2_4_net;
	electrical [0:0] tmpSIOVREF__P2_4_net;
	...
	cy_psoc3_pins_v1_10
		...
		P2_4
		 (.oe(tmpOE__P2_4_net),
		  .y({1'b0}),
		  .fb({Net_221}),
		  .io({tmpIO_0__P2_4_net[0:0]}),
		  .siovref(tmpSIOVREF__P2_4_net),
		  .interrupt({tmpINTERRUPT_0__P2_4_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__P2_4_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
