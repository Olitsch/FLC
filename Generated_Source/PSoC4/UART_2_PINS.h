...
/* Unconfigured pins */
#define UART_2_REMOVE_MOSI_SCL_RX_WAKE_PIN    (1u)
#define UART_2_REMOVE_MOSI_SCL_RX_PIN         (1u)
#define UART_2_REMOVE_MISO_SDA_TX_PIN         (1u)
...
/* Unconfigured pins */
#define UART_2_MOSI_SCL_RX_WAKE_PIN   (0u == UART_2_REMOVE_MOSI_SCL_RX_WAKE_PIN)
#define UART_2_MOSI_SCL_RX_PIN        (0u == UART_2_REMOVE_MOSI_SCL_RX_PIN)
#define UART_2_MISO_SDA_TX_PIN        (0u == UART_2_REMOVE_MISO_SDA_TX_PIN)
...
****************************************/
    ...
    #include "UART_2_spi_mosi_i2c_scl_uart_rx_wake.h"
#endif /* (UART_2_MOSI_SCL_RX_WAKE_PIN) */

#if(UART_2_MOSI_SCL_RX_PIN)
    #include "UART_2_spi_mosi_i2c_scl_uart_rx.h"
#endif /* (UART_2_MOSI_SCL_RX_PIN) */

#if(UART_2_MISO_SDA_TX_PIN)
    #include "UART_2_spi_miso_i2c_sda_uart_tx.h"
...
#if(UART_2_MOSI_SCL_RX_WAKE_PIN)
    #define UART_2_MOSI_SCL_RX_WAKE_HSIOM_REG  \
                                                (*(reg32 *) UART_2_spi_mosi_i2c_scl_uart_rx_wake__0__HSIOM)
    #define UART_2_MOSI_SCL_RX_WAKE_HSIOM_PTR  \
                                                ( (reg32 *) UART_2_spi_mosi_i2c_scl_uart_rx_wake__0__HSIOM)
    #define UART_2_MOSI_SCL_RX_WAKE_HSIOM_MASK \
                                                (UART_2_spi_mosi_i2c_scl_uart_rx_wake__0__HSIOM_MASK)
    #define UART_2_MOSI_SCL_RX_WAKE_HSIOM_POS  \
                                                (UART_2_spi_mosi_i2c_scl_uart_rx_wake__0__HSIOM_SHIFT)

    #define UART_2_MOSI_SCL_RX_WAKE_INTCFG_REG    (*(reg32 *) \
                                                              UART_2_spi_mosi_i2c_scl_uart_rx_wake__0__INTCFG)
    #define UART_2_MOSI_SCL_RX_WAKE_INTCFG_PTR    ( (reg32 *) \
                                                              UART_2_spi_mosi_i2c_scl_uart_rx_wake__0__INTCFG)

    #define UART_2_INTCFG_TYPE_MASK                  (0x03u)
    #define UART_2_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS  (UART_2_spi_mosi_i2c_scl_uart_rx_wake__SHIFT)
    #define UART_2_MOSI_SCL_RX_WAKE_INTCFG_TYPE_MASK ((uint32)                                           \
                                                                    ((uint32) UART_2_INTCFG_TYPE_MASK << \
                                                                    UART_2_MOSI_SCL_RX_WAKE_INTCFG_TYPE_POS))
#endif /* (UART_2_MOSI_SCL_RX_WAKE_PIN) */

#if(UART_2_MOSI_SCL_RX_PIN)
    #define UART_2_MOSI_SCL_RX_HSIOM_REG      (*(reg32 *) UART_2_spi_mosi_i2c_scl_uart_rx__0__HSIOM)
    #define UART_2_MOSI_SCL_RX_HSIOM_PTR      ( (reg32 *) UART_2_spi_mosi_i2c_scl_uart_rx__0__HSIOM)
    #define UART_2_MOSI_SCL_RX_HSIOM_MASK     (UART_2_spi_mosi_i2c_scl_uart_rx__0__HSIOM_MASK)
    #define UART_2_MOSI_SCL_RX_HSIOM_POS      (UART_2_spi_mosi_i2c_scl_uart_rx__0__HSIOM_SHIFT)
#endif /* (UART_2_MOSI_SCL_RX_PIN) */

#if(UART_2_MISO_SDA_TX_PIN)
    #define UART_2_MISO_SDA_TX_HSIOM_REG      (*(reg32 *) UART_2_spi_miso_i2c_sda_uart_tx__0__HSIOM)
    #define UART_2_MISO_SDA_TX_HSIOM_PTR      ( (reg32 *) UART_2_spi_miso_i2c_sda_uart_tx__0__HSIOM)
    #define UART_2_MISO_SDA_TX_HSIOM_MASK     (UART_2_spi_miso_i2c_sda_uart_tx__0__HSIOM_MASK)
    #define UART_2_MISO_SDA_TX_HSIOM_POS      (UART_2_spi_miso_i2c_sda_uart_tx__0__HSIOM_SHIFT)
#endif /* (UART_2_MISO_SDA_TX_PIN_PIN) */
...
#define UART_2_MOSI_SCL_RX_PIN_INDEX      (0u) /* RX pins without interrupt */
#define UART_2_MOSI_SCL_RX_WAKE_PIN_INDEX (0u) /* RX pin with interrupt     */
#define UART_2_MISO_SDA_TX_PIN_INDEX      (1u)
...
#define UART_2_MOSI_SCL_RX_PIN_MASK      ((uint32) 0x01u << UART_2_MOSI_SCL_RX_PIN_INDEX)
#define UART_2_MOSI_SCL_RX_WAKE_PIN_MASK ((uint32) 0x01u << UART_2_MOSI_SCL_RX_WAKE_PIN_INDEX)
#define UART_2_MISO_SDA_TX_PIN_MASK      ((uint32) 0x01u << UART_2_MISO_SDA_TX_PIN_INDEX)
...
/* Unconfigured SCB: scl signal */
#elif(UART_2_MOSI_SCL_RX_WAKE_PIN)
    #define UART_2_SET_I2C_SCL_DR(val) \
                            UART_2_spi_mosi_i2c_scl_uart_rx_wake_Write(val)
    ...
    #define UART_2_WAIT_SCL_SET_HIGH  (0u == UART_2_spi_mosi_i2c_scl_uart_rx_wake_Read())

#elif(UART_2_MOSI_SCL_RX_PIN)
    #define UART_2_SET_I2C_SCL_DR(val) \
                            UART_2_spi_mosi_i2c_scl_uart_rx_Write(val)
    ...
    #define UART_2_WAIT_SCL_SET_HIGH  (0u == UART_2_spi_mosi_i2c_scl_uart_rx_Read())
...
#elif(UART_2_MISO_SDA_TX_PIN)
    #define UART_2_WAIT_SDA_SET_HIGH  (0u == UART_2_spi_miso_i2c_sda_uart_tx_Read())
