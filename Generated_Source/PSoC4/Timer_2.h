...
/* Timer/Counter Mode */
/* Parameters */
#define Timer_2_TC_RUN_MODE                    (1lu)
...
#define Timer_2_TC_CAPTURE_SIGNAL_MODE         (1lu)

/* Signal present */
#define Timer_2_TC_RELOAD_SIGNAL_PRESENT       (1lu)
...
#define Timer_2_TC_CAPTURE_SIGNAL_PRESENT      (1lu)

/* Interrupt Mask */
#define Timer_2_TC_INTERRUPT_MASK              (2lu)
