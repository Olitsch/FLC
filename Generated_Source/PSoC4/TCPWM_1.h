...
#define TCPWM_1_TC_COMP_CAP_MODE               (0lu)
...
/* Interrupt Mask */
#define TCPWM_1_TC_INTERRUPT_MASK              (0lu)
...
/* Timer/Counter Mode */
#define TCPWM_1_TC_PERIOD_VALUE                (13000lu)
#define TCPWM_1_TC_COMPARE_VALUE               (6000lu)
#define TCPWM_1_TC_COMPARE_BUF_VALUE           (65535lu)
#define TCPWM_1_TC_COMPARE_SWAP                (0lu)

/* PWM Mode */
#define TCPWM_1_PWM_PERIOD_VALUE               (100lu)
...
#define TCPWM_1_PWM_MODE_CENTER                (TCPWM_1_CC_MATCH_INVERT       |   \
                                                         TCPWM_1_OVERLOW_NO_CHANGE     |   \
                                                         TCPWM_1_UNDERFLOW_CLEAR)
#define TCPWM_1_PWM_MODE_ASYM                  (TCPWM_1_CC_MATCH_NO_CHANGE    |   \
                                                         TCPWM_1_OVERLOW_SET           |   \
                                                         TCPWM_1_UNDERFLOW_CLEAR )
