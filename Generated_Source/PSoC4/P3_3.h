...
#define P3_3_DM_ALG_HIZ         (0x00u << P3_3_DRIVE_MODE_SHIFT)
#define P3_3_DM_DIG_HIZ         (0x01u << P3_3_DRIVE_MODE_SHIFT)
#define P3_3_DM_RES_UP          (0x02u << P3_3_DRIVE_MODE_SHIFT)
#define P3_3_DM_RES_DWN         (0x03u << P3_3_DRIVE_MODE_SHIFT)
#define P3_3_DM_OD_LO           (0x04u << P3_3_DRIVE_MODE_SHIFT)
#define P3_3_DM_OD_HI           (0x05u << P3_3_DRIVE_MODE_SHIFT)
#define P3_3_DM_STRONG          (0x06u << P3_3_DRIVE_MODE_SHIFT)
#define P3_3_DM_RES_UPDWN       (0x07u << P3_3_DRIVE_MODE_SHIFT)
